...
function: type=(INT_TYPE|FLOAT_TYPE|STRING_TYPE|BOOL_TYPE|NULL) FUNCTION NAME LP funcParam (COMMA funcParam)* RP COLON (action|returnStatement)+;
...
variable: type=INT_TYPE NAME IS (intExpr|nullExpr|inputExpr) DOT
